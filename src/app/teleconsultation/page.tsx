...
const doctors = [
  { id: 'doc1', name: 'Dr. Alemayehu Kassa', specialty: 'General Physician', experience: '10+ Years', consultationFee: 500, image: 'https://picsum.photos/seed/doc1/200/200', availability: ['Mon', 'Wed', 'Fri'], rating: 4.8, dataAiHint: 'doctor portrait' },
  { id: 'doc2', name: 'Dr. Fatuma Ahmed', specialty: 'Pediatrician', experience: '8 Years', consultationFee: 600, image: 'https://picsum.photos/seed/doc2/200/200', availability: ['Tue', 'Thu', 'Sat'], rating: 4.9, dataAiHint: 'female doctor' },
  { id: 'doc3', name: 'Dr. Tsegaye Lemma', specialty: 'Cardiologist', experience: '15 Years', consultationFee: 800, image: 'https://picsum.photos/seed/doc3/200/200', availability: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri'], rating: 4.7, dataAiHint: 'male doctor' },
];
  ...
  const handleConfirmBooking = () => {
    ...
    if (selectedDoctor && selectedDate && selectedTimeSlot) {
      const cartItem: Omit<CartItem, 'quantity'> = {
        ...
        name: `Consultation with ${selectedDoctor.name}`,
        price: selectedDoctor.consultationFee,
        image: selectedDoctor.image,
        dataAiHint: selectedDoctor.dataAiHint,
        type: 'teleconsultation',
        doctorDetails: `${selectedDoctor.name}, ${selectedDoctor.specialty}`,
      ...
      toast({
        ...
        description: `Your consultation with ${selectedDoctor.name} on ${format(selectedDate, 'PPP')} at ${selectedTimeSlot} is added to cart.`,
      });
            ...
            {filteredDoctors.map(doc => (
              <Card key={doc.id} className="hover:shadow-xl transition-shadow duration-300 flex flex-col">
                ...
                <CardContent className="flex-grow space-y-2">
                  ...
                  <p className="text-sm"><strong className="font-medium">Fee:</strong> {doc.consultationFee.toFixed(2)} ETB</p>
        ...
        <Card className="shadow-lg sticky bottom-4 z-10 md:static">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-secondary/50 p-4 rounded-md">
              ...
              <p className="text-sm"><strong>Fee:</strong> {selectedDoctor.consultationFee.toFixed(2)} ETB</p>
          ...
          <CardFooter className="flex justify-end gap-2">
            ...
            <Button className="bg-accent hover:bg-accent/90 text-accent-foreground" onClick={handleConfirmBooking}>
              <Video className="mr-2 h-4 w-4" /> Add to Cart & Pay
            </Button>
          </CardFooter>
        </Card>
      )}
