...
const articles = [
  { id: 'article1', title: 'Understanding Diabetes: Causes, Symptoms, and Management', summary: 'A comprehensive guide to living with diabetes, including diet tips and treatment options.', image: 'https://picsum.photos/seed/diabetesinfo/400/250', category: 'Diabetes Care', type: 'article', publishDate: '2024-07-15', dataAiHint: 'health book', href: '/health-hub/article1' },
  { id: 'article2', title: 'Malaria Prevention: Protecting Yourself and Your Family', summary: 'Learn effective strategies to prevent malaria, especially in high-risk areas.', image: 'https://picsum.photos/seed/malariaprevent/400/250', category: 'Infectious Diseases', type: 'article', publishDate: '2024-07-10', dataAiHint: 'mosquito net', href: '/health-hub/article2' },
  { id: 'article3', title: 'Hypertension: The Silent Killer and How to Control It', summary: 'Understand blood pressure, its risks, and lifestyle changes for better management.', image: 'https://picsum.photos/seed/hypertension/400/250', category: 'Heart Health', type: 'article', publishDate: '2024-07-05', dataAiHint: 'blood pressure', href: '/health-hub/article3' },
  { id: 'video1', title: 'Amharic Guide to Healthy Eating for Diabetics', summary: 'Watch this informative video in Amharic on meal planning for diabetes.', image: 'https://picsum.photos/seed/diabetesvideo/400/250', category: 'Diabetes Care', type: 'video', duration: '15:30', dataAiHint: 'video play button', href: '/health-hub/video1' },
  { id: 'faq1', title: 'Common Questions About Childhood Vaccinations', summary: 'Answers to frequently asked questions regarding vaccination schedules and safety.', image: 'https://picsum.photos/seed/vaccinefaq/400/250', category: 'Child Health', type: 'faq', dataAiHint: 'vaccine vial', href: '/health-hub/faq1' },
  { id: 'article4', title: 'Mental Wellness: Tips for a Healthy Mind', summary: 'Explore strategies for managing stress and improving overall mental well-being.', image: 'https://picsum.photos/seed/mentalwellness/400/250', category: 'Mental Health', type: 'article', publishDate: '2024-06-28', dataAiHint: 'calm person', href: '/health-hub/article4' },
];
